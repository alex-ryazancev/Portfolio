...
//     let ph1 = document.querySelector('.parallax-header__item_1'),
//         ph2 = document.querySelector('.parallax-header__item_2'),
//         ph3 = document.querySelector('.parallax-header__item_3'),
//         ph4 = document.querySelector('.parallax-header__item_4'),
//         ph5 = document.querySelector('.parallax-header__item_5'),
//         ph6 = document.querySelector('.parallax-header__item_6'),
...
//             if (welcomeOffset > 0) {
//                 this.move(ph1, wScroll, 350, 'y'); 
//                 this.move(ph2, wScroll, 300, 'y');
//                 this.move(ph3, wScroll, 190, 'y');
//                 this.move(ph4, wScroll, 60, 'y');
//                 this.move(ph5, wScroll, 250, 'y');
//                 this.move(ph6, wScroll, 250, 'y');
//             }
...
//         pf4 = document.querySelector('.parallax-footer__item_4'),
//         pf5 = document.querySelector('.parallax-footer__item_5'),
//         posl = `${50 - (mouseX - w) * 0.01}% ${50 - (mouseY - h) * 0.1}%`,
